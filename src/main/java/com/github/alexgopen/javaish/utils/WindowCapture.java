...
public class WindowCapture {
    ...
    public static boolean onCooldown() {
        return WindowCapture.lostCoordsTimestamp != 0
                && (System.currentTimeMillis() - WindowCapture.lostCoordsTimestamp) < 5000;
    }
    ...
    private static boolean shouldSearchCoords() {
        boolean shouldSearch = WindowCapture.lostCoordsTimestamp == 0
                || (System.currentTimeMillis() - WindowCapture.lostCoordsTimestamp) >= 5000;
